...
22.The coordinates of vertices of a triangle are \brak{x_1,y_1},\brak{x_2,y_2},and \brak{x_3,y_3}.The line joining the first two is divided into the ratio l:k, and line joining this point of division to the opposite angular point is then divided in the ratio m:k+l.Find the coordinates of the latter point of section.
\section{Solution}
\begin{figure}[h!]
       \centering
